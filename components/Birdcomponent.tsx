...
export default function Birdcomponent() {
  ...
  useEffect(() => {
    // Pulse animation every 5 seconds to catch attention
  ...
  return (
    ...
    >
      ...
      {/* Parrot with pulsing animation */}
      <div
        className={`transition-transform duration-300 w-[70px] h-[70px] md:w-[100px] md:h-[100px] hover:scale-110
